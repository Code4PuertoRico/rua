...
class MayanListView(ListView):
    template_name = 'generic_list.html'

    @classonlymethod
    def as_view(cls, **initkwargs):
        cls.global_permissions = initkwargs.pop('global_permission', [])
        cls.title = initkwargs.pop('title')
        cls.hide_links = initkwargs.pop('hide_links', False)
        cls.hide_link = initkwargs.pop('hide_link', False)
        cls.multi_select_as_buttons = initkwargs.pop('multi_select_as_buttons', False)
        view = super(MayanListView, cls).as_view(**initkwargs)
        return view
    ...
    def get_context_data(self, **kwargs):
        ...
        context['hide_links'] = self.hide_links
        context['hide_link'] = self.hide_link
        context['multi_select_as_buttons'] = self.multi_select_as_buttons
        return context
