...
urlpatterns = patterns('permissions.views',
    ...
    url(r'^role/create/$', MayanCreateView.as_view(), name='role_create'),
    url(r'^role/(?P<role_id>\d+)/permissions/$', 'role_permissions', (), name='role_permissions'),
    url(r'^role/(?P<role_id>\d+)/edit/$', MayanUpdateView.as_view(), name='role_edit'),
    url(r'^role/(?P<role_id>\d+)/delete/$', MayanDeleteView.as_view(), name='role_delete'),
