...
class IconSet(IconSetBase):
    ...
    dictionary = {
        ...
        CD_BURN: 'cd_burn.png',
        CEO: 'ceo.png',
        CEO_ADD: ['ceo.png', 'add.png'],
        CEO_DELETE: ['ceo.png', 'delete.png'],
        CEO_EDIT: ['ceo.png', 'pencil.png'],
        CHAIR: 'chair.png',
        CHAIR_ADD: ['chair.png', 'add.png'],
        CHAIR_DELETE: ['chair.png', 'delete.png'],
        CHAIR_EDIT: ['chair.png', 'pencil.png'],
        COG: 'cog.png',
        COG_ADD: 'cog_add.png',
        ...
        DISK: 'disk.png',
        DOOR: 'door.png',
        DOOR_ADD: ['door.png', 'add.png'],
        DOOR_DELETE: ['door.png', 'delete.png'],
        DOOR_EDIT: ['door.png', 'pencil.png'],
