...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DepartmentLocation.end_date'
        raise RuntimeError("Cannot reverse this migration. 'DepartmentLocation.end_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DepartmentLocation.start_date'
        raise RuntimeError("Cannot reverse this migration. 'DepartmentLocation.start_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AgencyPosition.start_date'
        raise RuntimeError("Cannot reverse this migration. 'AgencyPosition.start_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AgencyPosition.end_date'
        raise RuntimeError("Cannot reverse this migration. 'AgencyPosition.end_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AgencyEmployee.end_date'
        raise RuntimeError("Cannot reverse this migration. 'AgencyEmployee.end_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AgencyEmployee.start_date'
        raise RuntimeError("Cannot reverse this migration. 'AgencyEmployee.start_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AgencyDepartment.start_date'
        raise RuntimeError("Cannot reverse this migration. 'AgencyDepartment.start_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AgencyDepartment.end_date'
        raise RuntimeError("Cannot reverse this migration. 'AgencyDepartment.end_date' and its values cannot be restored.")
