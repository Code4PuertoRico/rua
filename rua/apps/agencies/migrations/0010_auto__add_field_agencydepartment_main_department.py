...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgencyDepartment.main_department'
        db.add_column(u'agencies_agencydepartment', 'main_department',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgencyDepartment.main_department'
        db.delete_column(u'agencies_agencydepartment', 'main_department')
